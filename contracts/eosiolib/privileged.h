...
extern "C" {
  ...
  /**
   * @brief Set guaranteed minimum resources
   * @param ram_byte - ram limit in absolute bytes
   * @param cpu_us - cpu limit in absolute us
   * @param net_byte - net limit in absolute bytes
   */
