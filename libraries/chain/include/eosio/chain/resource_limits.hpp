...
namespace eosio { namespace chain { namespace resource_limits {
   ...
   class resource_limits_manager {
      public:
         ...
         */
         void set_gmr_parameters( const gmr_parameters&  res_parameters ); // guaranteed minimum resources  which is abbreviated  gmr
         gmr_parameters get_gmr_parameters();
         ...
         void get_account_limits( const account_name& account, int64_t& ram_bytes, int64_t& net_weight, int64_t& cpu_weight, bool raw = false) const;
