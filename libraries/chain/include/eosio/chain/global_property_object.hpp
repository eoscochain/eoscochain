...
namespace eosio { namespace chain {
   ...
   {
      OBJECT_CTOR(global_property_object, (proposed_schedule)(onchain_whiteblacklist))

      id_type                           id;
      optional<block_num_type>          proposed_schedule_block_num;
      shared_producer_schedule_type     proposed_schedule;
      chain_config                      configuration;
      shared_onchain_whiteblacklist_type onchain_whiteblacklist;
   };
...
FC_REFLECT(eosio::chain::global_property_object,
           (proposed_schedule_block_num)(proposed_schedule)(configuration)(onchain_whiteblacklist)
          )
